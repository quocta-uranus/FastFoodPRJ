...
<html>
  ...
  <style>
    ...
    <body>
        ...
        <div style="margin:100px 0 260px 0">
            ...
            <div style=" text-align: center; margin-bottom: 30px;">
                <h1 class="titlee">Đơn hàng đã xác nhận </h1>
            ...
            <%
                ...
                List<Order> listPreparing = (List)request.getAttribute("listPreparing");
                int num = listPreparing.size();
            %>
            ...
            <h2 class="totall">Tổng số đơn hàng đang giao: <%= num%> đơn  </h2>
                <table class="table">
                    ...
                    <tbody>
                        <c:forEach var="order" varStatus="loop" items="${listPreparing}">
                            <tr>
                                ...
                                <td style="display:flex; gap:40px; justify-content: center;">
                                    <form action="PreparingOrderServlet" method="POST">
