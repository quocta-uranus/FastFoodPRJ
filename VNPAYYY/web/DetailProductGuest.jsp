            ...
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <div> 
                    ...
                    <a class="btn-book-a-table">
                        <span style="color:white; font-weight: bold"> GUEST</span>
                    </a>
                     <a href="#" onclick="logout()"><i class="fa-solid fa-right-to-bracket fa-beat fa-2xl" style="color: #ff0000; margin-left: 20px;"></i></a>
                </div>
         ...
         <div class="modal" id="myModal">
            <div class="modal-content" style="width: 30%;">
                <h5 style=" margin-bottom: 20px;">
                    Bạn có chắc chắn bạn muốn đăng nhập?</h5>
