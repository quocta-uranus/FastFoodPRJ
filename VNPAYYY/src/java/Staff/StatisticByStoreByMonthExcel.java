 ...
 * @author Asus
 */
public class StatisticByStoreByMonthExcel extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet StatisticByStoreByMonthExcel</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet StatisticByStoreByMonthExcel at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int sumByStore = orderDAO.sumOrderOfStoreByMonth(month, year, store_id);
            ...
            Logger.getLogger(StatisticByStoreByMonthExcel.class.getName()).log(Level.SEVERE, null, ex);
