...
public class AddStoreServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddStoreServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddStoreServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            String timeOC = request.getParameter("ocTime");
            String phoneNumber = request.getParameter("phoneNumber");
            StoreDAO storeDAO = new StoreDAO();
            storeDAO.addStore(store_name, address, timeOC, timeOC, phoneNumber);
