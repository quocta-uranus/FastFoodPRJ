...
import Staff.StatisticByStoreByDateExcel;
import dal.OrderDAO;
import dal.StoreDAO;
 ...
 * @author Asus
 */
public class StatisticAllByDateExcel extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet StatisticAllByDateExcel</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet StatisticAllByDateExcel at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int sumByStore = orderDAO.sumOrderByDate(date);
            ...
            try ( XSSFWorkbook workbook = new XSSFWorkbook();  OutputStream out = response.getOutputStream()) {
                XSSFSheet sheet = workbook.createSheet("Doanh_Thu_Theo_Ngay_Cua_He_Thong");
                ...
                XSSFRow ordersHeaderRow = sheet.createRow(2);
                ...
                response.setHeader("Content-Disposition", "attachment; filename=Doanh_thu_ngay_"+date+"_cua_he_thong.xlsx");
