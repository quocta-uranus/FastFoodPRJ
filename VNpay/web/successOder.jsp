...
<html>
    ...
    <body>
      ...
      <div style="border-radius:200px; height:200px; width:200px; background: #F8FAF5; margin:0 auto; text-align: center;">
        ...
        <h1>Thành công</h1> 
        <p class="p">Đơn hàng của bạn đã được đặt và đang trong quá trình xác nhận, vui lòng kiểm tra mail để biết thêm chi tiết !</p>
        <p class="p">FastFood xin chân thành cảm ơn.</p>
        <button class="btn btn-secondary mt-4">  <a style=" 
         color: white; text-decoration: none;" href="ListProductCustomer">Trở về</a> </button>
      </div>
